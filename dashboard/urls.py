...
urlpatterns = [
    ...
    path('logistica/viaje/<int:pk>/editar/', views.ViajeNuevoUpdateView.as_view(), name='viaje_editar'),
    path('logistica/viaje/<int:pk>/cambiar-estado/', views.ViajeCambiarEstadoView.as_view(), name='viaje_cambiar_estado'),
    path('logistica/viaje/<int:pk>/cancelar/', views.ViajeCancelarView.as_view(), name='viaje_cancelar'),
